...
public interface UsuarioMapper {
     ...
     * @author driveros
     */
    @Select(" SELECT ID_USUARIO AS IDUSUARIO, PASSWORD, USUARIO AS USUARIO, NOMBRES, APELLIDO_P AS APELLIDOP, APELLIDO_M AS APELLIDOM, ID_ESTADO_USUARIO, HABILITADO  " +
            " FROM USUARIO u" +
